      ...
      <section className="bg-brand-surface py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              "https://www.mcburneytransportgroup.com/wp-content/uploads/bfi_thumb/mcburney_kells-mpa4x2acr2l37a4zssipf5n3tgip10b831m8mxy30y.jpg",
              "https://www.mcburneytransportgroup.com/wp-content/uploads/bfi_thumb/mcburney_7365a-mpa4ve4oloaqk8kdk2ikzktlssr7cdoeirv5x8fa36.jpg",
              "https://www.mcburneytransportgroup.com/wp-content/uploads/bfi_thumb/ourcompanies-1-mpa4z0s8zn9le1ald4zq45uodcv82b33cqjnmp1k2a.jpg",
            ].map((src, index) => (
